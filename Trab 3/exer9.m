...
plot(ax(1), Ez(150, :, 51));
plot(ax(4), Ez(180, :, 51));
plot(ax(7), reshape(Ez(150, 51, :), 1, 101));
plot(ax(10), reshape(Ez(180, 51, :), 1, 101));

plot(ax(2), Hx(150, :, 51));
plot(ax(5), Hx(180, :, 51));
plot(ax(8), reshape(Hx(150, 51, :), 1, 101));
plot(ax(11), reshape(Hx(180, 51, :), 1, 101));

plot(ax(3), Hy(150, :, 51));
plot(ax(6), Hy(180, :, 51));
plot(ax(9), reshape(Hy(150, 51, :), 1, 101));
plot(ax(12), reshape(Hy(180, 51, :), 1, 101));

for k = 1:4
    axis(ax(1 + (k - 1) * 3), [0 100 -.2 .2])
    yticks(ax(1 + (k - 1) * 3), [-.2 -.1 0 .1 .2])
    for j = 2:3
        axis(ax(j + (k - 1) * 3), [0 100 -7.5e-3 7.5e-3])
        yticks(ax(j + (k - 1) * 3), [-7.5e-3 -5e-3 -2.5e-3 0 2.5e-3 5e-3 7.5e-3])
    end
end

title(ax(1), 'j = 50 n = 150')
title(ax(2), 'j = 50 n = 150')
title(ax(3), 'j = 50 n = 150')
title(ax(4), 'j = 50 n = 180')
title(ax(5), 'j = 50 n = 180')
title(ax(6), 'j = 50 n = 180')
title(ax(7), 'i = 50 n = 150')
title(ax(8), 'i = 50 n = 150')
title(ax(9), 'i = 50 n = 150')
title(ax(10), 'i = 50 n = 180')
title(ax(11), 'i = 50 n = 180')
title(ax(12), 'i = 50 n = 180')
